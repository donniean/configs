...
function error(message: Message, options?: LeveledLogOptions) {
  log({ level: 'error', message, ...options });
}

function warn(message: Message, options?: LeveledLogOptions) {
  log({ level: 'warn', message, ...options });
}

function info(message: Message, options?: LeveledLogOptions) {
  log({ level: 'info', message, ...options });
}

function debug(message: Message, options?: LeveledLogOptions) {
  log({ level: 'debug', message, ...options });
}

function messageOnly(message: Message, options?: LeveledLogOptions) {
...
export { command, debug, error, info, lf, log, messageOnly, warn };
